...
public class OnPokemonTradeGet extends Objective {
    ...
    public void onPokemonTrade(PixelmonTradeEvent.Post event) {
        ...
        IntegrationFactoryImpl.logger.debug("pixelmon.trade.get: " + player.getName());
        IntegrationFactoryImpl.logger.debug("pixelmon.trade.get: " + SpecUtil.match(pixelmon, SpecUtil.parseSpecs(specs)));
