...
public class OnApricornHarvest extends Objective {
    ...
    public void onApricornHarvestListener(ApricornEvent.Pick event) {
        ...
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.apricorn.harvest: " + event.getApricorn().apricorn().apricorn.name());
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.apricorn.harvest: " + apricorn);
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.apricorn.harvest: " + (apricorn.equals("*") || event.getApricorn().apricorn().apricorn.name().toLowerCase().contains(apricorn.toLowerCase())));
