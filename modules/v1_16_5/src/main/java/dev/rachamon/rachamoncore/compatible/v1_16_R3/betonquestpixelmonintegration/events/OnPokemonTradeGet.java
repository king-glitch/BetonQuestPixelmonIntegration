...
public class OnPokemonTradeGet extends Objective {
    ...
    public void onPokemonTrade(PixelmonTradeEvent.Post event) {
        ...
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.trade.get: " + SpecUtil.match(pixelmon1, SpecUtil.parseSpecs(specs)));
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.trade.get: " + SpecUtil.match(pixelmon2, SpecUtil.parseSpecs(specs)));
