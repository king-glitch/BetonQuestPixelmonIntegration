...
public class OnHatchPokemonEgg extends Objective {
    ...
    public void onEggHatched(EggHatchEvent.Post event) {
        ...
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.hatch: " + event.getPokemon().getDisplayName());
        BetonQuestObjectiveFactoryImpl.instance.getModuleLogger().debug("pixelmon.hatch: " + SpecUtil.match(event.getPokemon(), SpecUtil.parseSpecs(specs)));
